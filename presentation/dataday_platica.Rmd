...
|     |     H|     M|     O|        $H_s$ |        $M_s$ |        $O_s$ |
|  ---| -----| -----| -----| -------------| -------------| -------------|
|  0  |   1.0|   0.0|   0.0|   $\pi_{0,H}$|   $\pi_{0,M}$|   $\pi_{0,O}$|
|  1  |   1.0|   0.0|   0.0|   $\pi_{1,H}$|   $\pi_{1,M}$|   $\pi_{1,O}$|
|  2  |   0.0|   1.0|   0.0|   $\pi_{2,H}$|   $\pi_{2,M}$|   $\pi_{2,O}$|
|  3  |   1.0|   0.0|   0.0|   $\pi_{3,H}$|   $\pi_{3,M}$|   $\pi_{3,O}$|
|  4  |   1.0|   0.0|   0.0|   $\pi_{4,H}$|   $\pi_{4,M}$|   $\pi_{4,O}$|
|  5  |   1.0|   0.0|   0.0|   $\pi_{5,H}$|   $\pi_{5,M}$|   $\pi_{5,O}$|
|  6  |   1.0|   0.0|   0.0|   $\pi_{6,H}$|   $\pi_{6,M}$|   $\pi_{6,O}$|
|  7  |   1.0|   0.0|   0.0|   $\pi_{7,H}$|   $\pi_{7,M}$|   $\pi_{7,O}$|
|  8  |   1.0|   0.0|   0.0|   $\pi_{8,H}$|   $\pi_{8,M}$|   $\pi_{8,O}$|
|  9  |   0.0|   0.0|   1.0|   $\pi_{9,H}$|   $\pi_{9,M}$|   $\pi_{9,O}$|
...
background-size: 512px
background-position: 45% 10%
## Después de un nivel de dispersión mayor al 40%, pierde relevancia la inclusión o no inclusión del valor real. 
---
class: center, bottom, inverse
...
### Referencias
[*Dwork*](https://link.springer.com/content/pdf/10.1007/978-3-540-30576-7_20.pdf) - Cynthia Dwork 

[*Esponda*](http://agl.cs.unm.edu/~forrest/publications/final-2007.pdf) - Fernando Esponda 
